  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-hidden placeholder:text-oklch(0.556 0 0) disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-oklch(0.708 0 0)",
          className
        )}
        {...props}
      />
